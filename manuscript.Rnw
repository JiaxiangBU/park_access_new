...
and significant relationship between park access and physical activity rates, and
a clear negative relationship between park access and obesity rates. Applying
a more traditional analysis considering 1/4 mile acess to parks yields mixed
results.
\end{abstract}
...
key health indicators available through its 500 Cities data program \citep{CDC5002016}. The models
