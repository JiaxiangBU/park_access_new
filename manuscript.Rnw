...
%% Front matter =========================
\title{Modeling the impacts of park access on health outcomes: a choice-based 
accessibility approach}

\author{Gregory S. Macfarlane, Nico Boyd, John E. Taylor, and Kari Watkins}
...
in sufficient physical activity, a problem compounded by age and socioeconomic 
status. As the epidemiological transition from
