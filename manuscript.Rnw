...
significant negative relationship between park access and obesity rates.
Applying a more traditional analysis considering 1/4 mile access to parks yields
mixed results and cannot accommodate features such as park size and twitter
activity.
\end{abstract}
